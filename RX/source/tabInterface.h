...
void tab_init()
{
    ...
    pinDato_dir =    OUTPUT;
    pinClock_dir =   OUTPUT;
    pinLocali_dir =  OUTPUT;
    pinTempo_dir =   OUTPUT;
    pinOspiti_dir =  OUTPUT;
    pinClaxon_dir =  OUTPUT;
...
void ___tab_refresh_teamdata(TTeamData* instance)
{
    ...
    refr_dato.B5 = instance -> P7F;
    refr_dato.B4 = instance -> P1;
    refr_dato.B3 = instance -> P2;
